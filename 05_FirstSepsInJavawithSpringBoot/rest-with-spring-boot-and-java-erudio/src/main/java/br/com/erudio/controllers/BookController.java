...
public class BookController {
	...
	@GetMapping(value = "/findBookByTitle/{title}",
			produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Finding all books with passed title!", description = "Finding all books with passed title!",
		tags = {"Books"},
		responses = {
	...
	@Operation(summary = "Deletes a Book", description = "Deletes a Book by passing the id of the Book",
		tags = {"Books"},
		responses = {
			@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
